...
<body>
    <div class="box">
        <form method="post" action="signup_proc.php">
            ...
            <div class="inputBox">
                <input type="password" required="required" id="cpassword" name="Passowrd"
            ...
            <div class="inputBox">
                ...
                <!-- <input type="country" required="required" name="country" placeholder="Nationality"> -->
                <select class="country" name="country" id="country">
                    <option><span style="color:white;"> select country</span></option>
            ...
            <input type="submit" name="register" id="register" value="Register" onclick="return Validate()">
        </form>
    </div>
